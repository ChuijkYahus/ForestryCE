...
Three recipes stop compiling in core and must move. They are exactly the files the promotion pass
moves today:

| file | promoted today to | moves to |
| --- | --- | --- |
| `data/forestry/recipe/fabricator/electron_tubes/ender.json` | farms | `forestry.agriculture.data` |
| `data/forestry/recipe/foresters_manual_butterfly.json` | butterflies | `forestry.lepidopterology.data` |
| `data/forestry/recipe/lepidopterists_chest.json` | butterflies | `forestry.lepidopterology.data` |
