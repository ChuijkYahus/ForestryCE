...
public class Data {
	...
	public static void preDataGen() {
		...
		// Other providers that build recipes/loot referencing bee species by id (e.g. the centrifuge recipe for
		// bee_relic) need real species objects in memory *during this same run*, so seed the live species type
		// directly from the same DefaultBeeSpecies source BeeSpeciesProvider itself generates JSON from.
