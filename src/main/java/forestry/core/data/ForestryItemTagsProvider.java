...
public class ForestryItemTagsProvider {
	public static void addTags(MKTagsProvider<Item> tags) {
		...
		tags.tag(ForestryTags.Items.DROP_HONEY).add(ApicultureItems.HONEY_DROP, ApicultureItems.HONEYDEW, ApicultureItems.EXPERIENCE_DROP, ApicultureItems.MAGMATIC_DROP);
