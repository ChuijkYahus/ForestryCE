...
public class AlvearyScreen extends GuiForestryTitled<AlvearyMenu> {
	private final AbstractAlvearyBlockEntity tile;

	public AlvearyScreen(AlvearyMenu container, Inventory inventory, Component title) {
