...
public class FactoryTiles {
	...
	public static final FeatureTileType<TileRaintank> RAIN_TANK = REGISTRY.tile(TileRaintank::new, "raintank", () -> FactoryBlocks.RAINTANK.get(BlockTypeFactoryRaintank.RAINTANK).collect());
