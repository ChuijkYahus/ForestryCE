...
public enum BlockTypeFactoryBarrel implements IBlockType {

	RAINTANK(FactoryTiles.RAIN_TANK, "raintank", TileRaintank::serverTick);

	private final IMachineProperties<?> machineProperties;

	<T extends TileBase> BlockTypeFactoryBarrel(FeatureTileType<T> teClass, String name, @Nullable IForestryTicker<T> serverTicker) {
