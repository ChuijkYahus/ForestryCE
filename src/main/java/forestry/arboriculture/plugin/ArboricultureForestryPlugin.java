...
import forestry.arboriculture.trees.genetics.TreeSpeciesType;
...
import forestry.arboriculture.trees.ArboricultureFilterRuleType;
import forestry.arboriculture.fruit.DummyFruit;
import forestry.arboriculture.fruit.PodFruit;
import forestry.arboriculture.fruit.RipeningFruit;
import forestry.arboriculture.fruit.ForestryPodType;
import forestry.arboriculture.trees.genetics.BlossomingTreeEffect;
import forestry.arboriculture.trees.genetics.DummyTreeEffect;
import forestry.arboriculture.trees.genetics.TreePollenType;
...
public class ArboricultureForestryPlugin implements IForestryPlugin {
	...
	public void registerArboriculture(IArboricultureRegistration arboriculture) {
		...
		arboriculture.registerFruit(ForestryFruits.CHESTNUT, new RipeningFruit(true, 6, nuts, 0x76403C, 0xc4d24a, List.of(Product.of(CoreItems.FRUITS.item(FruitItemType.CHESTNUT)))));
		arboriculture.registerFruit(ForestryFruits.WALNUT, new RipeningFruit(true, 8, nuts, 0xBC784E, 0xc4d24a, List.of(Product.of(CoreItems.FRUITS.item(FruitItemType.WALNUT)))));
		arboriculture.registerFruit(ForestryFruits.CHERRY, new RipeningFruit(true, 10, berries, 0xCC1C10, 0xc4d24a, List.of(Product.of(CoreItems.FRUITS.item(FruitItemType.CHERRY))))); //Should be a Drupe, actually
		arboriculture.registerFruit(ForestryFruits.DATES, new PodFruit(false, ForestryPodType.DATES, List.of(Product.of(CoreItems.FRUITS.item(FruitItemType.DATE)))));
		arboriculture.registerFruit(ForestryFruits.PAPAYA, new PodFruit(false, ForestryPodType.PAPAYA, List.of(Product.of(CoreItems.FRUITS.item(FruitItemType.PAPAYA)))));
		arboriculture.registerFruit(ForestryFruits.LEMON, new RipeningFruit(true, 10, citrus, 0xFFD500, 0x99ff00, List.of(Product.of(CoreItems.FRUITS.item(FruitItemType.LEMON)))));
		arboriculture.registerFruit(ForestryFruits.PLUM, new RipeningFruit(true, 10, plums, 0x773352, 0xeeff1a, List.of(Product.of(CoreItems.FRUITS.item(FruitItemType.PLUM))))); //Should also be a drupe

		arboriculture.registerFruit(ForestryFruits.COCONUT, new PodFruit(false, ForestryPodType.COCONUT, List.of(Product.of(CoreItems.FRUITS.item(FruitItemType.COCONUT)))));
		arboriculture.registerFruit(ForestryFruits.PEAR, new RipeningFruit(true, 10, pomes, 0xD8D345, 0xE3DD9C, List.of(Product.of(CoreItems.FRUITS.item(FruitItemType.PEAR)))));
		arboriculture.registerFruit(ForestryFruits.FEIJOA, new RipeningFruit(true, 10, berries, 0x7AB15C, 0x6A7D7B, List.of(Product.of(CoreItems.FRUITS.item(FruitItemType.FEIJOA))))); //What actually is a feijoa? I couldn't find the answer.
		arboriculture.registerFruit(ForestryFruits.ORANGE, new RipeningFruit(true, 10, citrus, 0xF4842D, 0xBCA627, List.of(Product.of(CoreItems.FRUITS.item(FruitItemType.ORANGE)))));
		arboriculture.registerFruit(ForestryFruits.OLIVE, new RipeningFruit(true, 10, berries, 0xAAC348, 0x604632, List.of(Product.of(CoreItems.FRUITS.item(FruitItemType.OLIVE))))); //Should also be a drupe
