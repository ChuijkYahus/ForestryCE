...
public class CharcoalBlocks {
	...
	public static final FeatureBlock<BlockCharcoal, ItemBlockForestry<BlockCharcoal>> CHARCOAL = REGISTRY.block(BlockCharcoal::new, BlockBehaviour.Properties::of, ItemBlockForestry::new, () -> new ItemProperties().burnTime(16000), "charcoal_block");
