...
public abstract class ForestryTreeFeature extends AbstractArboricultureFeature {
	...
	protected ForestryTreeFeature(ITreeGenData tree, int baseHeight, int heightVariation, int minHeightOverride) {
		super(tree);
	...
	protected ForestryTreeFeature(ITreeGenData tree, int baseHeight, int heightVariation) {
		super(tree);
		this.baseHeight = baseHeight;
		this.heightVariation = heightVariation;
		this.minHeight = 4;
