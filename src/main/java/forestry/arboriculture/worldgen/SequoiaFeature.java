...
public class SequoiaFeature extends ForestryTreeFeature {
	public SequoiaFeature(ITreeGenData tree) {
		this(tree, 20, 5);
	}

	protected SequoiaFeature(ITreeGenData tree, int baseHeight, int heightVariation) {
