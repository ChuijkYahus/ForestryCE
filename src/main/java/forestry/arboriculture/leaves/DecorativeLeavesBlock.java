...
public class DecorativeLeavesBlock extends Block implements IColoredBlock, IShearable {
	private final ForestryLeafType type;

	public DecorativeLeavesBlock(Properties properties, ForestryLeafType type) {
		super(properties
			.strength(0.2f)
