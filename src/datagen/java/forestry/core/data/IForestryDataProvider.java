 ...
 * content jar's types directly. Once each jar's datagen package moves into that jar's own source set,
 * the compile classpath enforces what this indirection only asks of it today.
 *
