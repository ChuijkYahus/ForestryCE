...
public class ForestryBlockStateProvider extends BlockStateProvider {
	...
	// provider rather than by this one. Every static below does the same, and each takes
	// BlockStateProvider, the widest type that answers, so a caller need not be one of these
