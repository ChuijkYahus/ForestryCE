package forestry.agriculture.multifarm.circuits;
...
public class MultifarmCircuit extends Circuit implements IFarmCircuit {
	private final Supplier<IFarmType> farmType;
	private final boolean manual;

	public MultifarmCircuit(String uid, ResourceLocation farmTypeId, boolean manual) {
		super(uid);
