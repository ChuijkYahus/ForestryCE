...
import forestry.core.platform.gui.GuiTextBox;
...
public class LetterScreen extends GuiForestry<LetterMenu> {
	...
	public LetterScreen(LetterMenu container, Inventory inv, Component title) {
